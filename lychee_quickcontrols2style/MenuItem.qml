...
T.MenuItem {
    ...
    arrow: ColorImage {
        ...
        color: control.palette.text
        source: control.subMenu ? Lychee.url + "arrow-indicator-light.png" : ""
    ...
    indicator: ColorImage {
        ...
        source: control.checked ? Lychee.url + "radiodelegate-indicator-light.png" : ""
        color: control.palette.text
    }
    ...
    background: Item {
        ...
        NinePatchImage {
            ...
            source: Lychee.url + "menuitem-background"
